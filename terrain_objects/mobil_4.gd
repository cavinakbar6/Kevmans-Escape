...
@export var spawn_x_range: Vector2 = Vector2(0.15, 0.85)
...
@onready var objek_name = scene_file_path.get_file().get_basename() #ambil nama objek dari scene
@onready var spawn_message = objek_name + " spawned"
@onready var incoming_damage_message = "damage coming from " + objek_name
